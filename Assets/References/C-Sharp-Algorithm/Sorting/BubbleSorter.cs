...
namespace Algorithms.Sorting
{
    public static class BubbleSorter
    {
        ...
        public static void BubbleSort(this float[] collection)
        {
            collection.BubbleSortAscending();
        }
        ...
        public static void BubbleSortAscending(this float[] collection)
        {
            for (int i = 0; i < collection.Length; i++)
            {
                for (int index = 0; index < collection.Length - i - 1; index++)
                {
